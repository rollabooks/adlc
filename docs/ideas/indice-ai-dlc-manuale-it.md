...
| Sorgente principale | `source/.ai-dlc/MANUAL.it.md` + tutti i moduli in `source/.ai-dlc/modules/` |
...
- Override di progetto in `.ai-dlc/project/halt-triggers.yaml`
...
- Aggiungere Skill personalizzate in `.ai-dlc/project/skills/`
...
- Creare shortcut di progetto in `.ai-dlc/project/instructions.md`
...
- Company extension (`.ai-dlc/company/`): SDLC aziendale, governance, compliance
