...
Template copiabili per i file più usati di ADLC. Sostituisci i valori tra \texttt{[parentesi]} con quelli reali del tuo progetto. I template completi in formato Markdown sono in \texttt{.adlc/modules/templates/}.
