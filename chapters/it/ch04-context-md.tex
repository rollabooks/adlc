...
Il framework offre due template in \texttt{.adlc/modules/templates/}:
...
\textbf{Mettere troppo nel context.} Le regole dettagliate del progetto vanno in \texttt{.adlc/project/instructions.md}. Il context contiene lo stato attuale, non il manuale del progetto.
