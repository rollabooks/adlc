...
\textbf{ADLC} --- \textit{AI-Driven Software Development Life Cycle} --- è quel sistema. Non è un'AI, non è un tool da installare, non è un framework specifico per un linguaggio. È un insieme di file Markdown e JSON che vivono nel tuo repository e che dicono all'agente:
...
\textbf{Parte I --- Il Framework} (Capitoli 1--3) ti porta da zero a una prima sessione di lavoro funzionante. Se vuoi testare ADLC subito, puoi leggere solo questa parte e tornare al resto quando ne hai bisogno.
