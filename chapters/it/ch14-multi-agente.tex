...
ADLC è progettato per funzionare con più agenti, simultaneamente o in sequenza, sullo stesso progetto, con lo stesso \texttt{\_CONTEXT.md} come fonte di verità condivisa.
