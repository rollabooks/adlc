...
\begin{notebox}
I file \texttt{AGENTS.md}, \texttt{CLAUDE.md}, ecc. sono read-only per l'uso normale --- non modificarli. Le tue personalizzazioni vanno in \texttt{.adlc/project/} (lo vediamo al §\ref{sec:02-project-dir}).
\end{notebox}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{ll}
    ...
    \texttt{.adlc/project/instructions.md} & Regole specifiche per il progetto \\
    \texttt{.adlc/project/skills/} & Skill personalizzate \\
    \bottomrule
  \end{tabular}
...
\section{Struttura raccomandata per \texttt{.adlc/project/}}
...
\begin{lstlisting}[language=,caption={.adlc/project/instructions.md di TaskFlow API}]
