...
Vive in \texttt{.adlc/halt-triggers.yaml} ed è già lì dopo \texttt{init}. I sei trigger predefiniti:
...
Le zone sensibili specifiche del tuo progetto vanno in \texttt{.adlc/project/halt-triggers.yaml}:
...
\begin{itemize}
  \item I sei trigger predefiniti coprono: schema DB, auth, secrets, infra, CI/CD, framework ADLC.
  \item Gli override di progetto in \texttt{.adlc/project/halt-triggers.yaml} estendono (o disattivano) i trigger predefiniti.
