...
\midrule
Dieci minuti per riepilogare stack, vincoli e contesto del task & Bootstrap: l'agente conferma tutto in pochi secondi leggendo il file \\[3pt]
...
\begin{lstlisting}[language=,caption={Schema del ciclo AI-DLC per sessione}]
INIZIO SESSIONE
...
\diagramfig{ch03-ciclo-sessione}{Il ciclo di una sessione AI-DLC, dal bootstrap al checkpoint.}
