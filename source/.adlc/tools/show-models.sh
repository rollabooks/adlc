...
usage() {
  cat <<'EOF'
Usage: bash .adlc/tools/show-models.sh [--root PATH] [--format table|json] [--vendor anthropic|openai|gemini|all]

Prints the model level mapping from .adlc/manifest.json#model_levels.
EOF
}
