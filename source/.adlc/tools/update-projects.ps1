...
foreach ($context in $contexts) {
  ...
  $projects += [ordered]@{
    ...
    project_rules = (Join-Path $relativeRoot ".adlc/project") -replace "\\", "/"
    company_extension = (Join-Path $relativeRoot ".adlc/company") -replace "\\", "/"
  }
}
